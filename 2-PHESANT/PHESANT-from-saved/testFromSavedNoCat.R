...
write("varName,varType,n,beta,lower,upper,pvalue", file=paste(opt$resDir,"results-linear-", opt$partIdx, "-", opt$numParts, ".txt",sep=""), append=FALSE)
write("varName,varType,n,beta,lower,upper,pvalue", file=paste(opt$resDir,"results-ordered-logistic-", opt$partIdx, "-", opt$numParts, ".txt",sep=""), append=FALSE)
write("varName,varType,n,beta,lower,upper,pvalue", file=paste(opt$resDir,"results-multinomial-logistic-", opt$partIdx, "-", opt$numParts, ".txt",sep=""), append=FALSE)
...
testBinary(opt$resDir, opt$partIdx, opt$numParts, confounders, exposure, opt$traitofinterest, opt$userId, opt$phenoDir)
